...
function addGamesToPage(games) {
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    let currentGameElement = document.createElement("div");
    // add the class game-card to the list
    currentGameElement.classList.add("game-card");
    ...
    let currentInnerHTML = `
        ...
        `;
    currentGameElement.innerHTML = currentInnerHTML;
    // append the game to the games-container
    gamesContainer.appendChild(currentGameElement);
  }
}
...
const unfundedStringTemplate = `A total of \$${totalMoneyRaised} has been raised for ${
  GAMES_JSON.length
...
unfundedParaElement.innerHTML = unfundedStringTemplate;
